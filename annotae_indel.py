#!/usr/bin/python
## usage: xxx.py -contg contg-dic -gene gene-dic -CDS CDS-dic -mol mol-dic -gene_ref gene_ref_dic -SNP_table SNP_file
import sys
import os
import pickle
import re
...
#			print contig,geneID
			...
			if st <= pos <= ed and gene_dic.has_key(geneID)==0: # the SNP is in some psudo-gene
