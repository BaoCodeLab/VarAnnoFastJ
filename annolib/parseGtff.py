...
#    CDSseq_dic,pseudoSeq_dic,rnaSeq_dic={},{},{}
...
#        pickle.dumps(contg_dic,out_contgDic)
...
def parseGTFF(args):
    ...
    if args.ref != None and args.gtff !=None and args.prefix != None:
        ref_file = args.ref
        gtff_file = args.gtff
        out_prefix = args.prefix

        allDic = writeDic(ref_file,gtff_file,out_prefix)
        ...
        raise Exception("Please provide the reference genome file, gtff annotaiton file and output prefix.")
